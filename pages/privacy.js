...
const Privacy = () => {
  return (
    <section className={styles.Privacy}>
      <h1>Privacy Policy for thecodecreative.com</h1>
      {/* <p>
        At thecodecreative.com, accessible from thecodecreative.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        thecodecreative.com and how we use it.
      </p>
      ...
      <h2>Log Files</h2>
      <p>
        thecodecreative.com follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, thecodecreative.com uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of thecodecreative.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on thecodecreative.com, which are
      ...
      <p>
        Note that thecodecreative.com has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>
      <p>
        thecodecreative.com's Privacy Policy does not apply to other advertisers
      ...
      <p>
        thecodecreative.com does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in thecodecreative.com. This policy is not
