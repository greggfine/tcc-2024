...
<YouTube id="3NgVlAscdcA" alt="how to load an audio file using fetch video" imgSrc="/images/blog/loading-audio-files-with-fetch/loading-audio-files-with-fetch-video.jpg" />
