...
<Image
  src="https://greggfine.github.io/tcc-2024/images/blog/autoplay-policy-in-google-chrome/audioctx-suspension-reduced.png"
  width={600}
  height={98}
  layout="responsive"
...
<YouTube
  id="sLXcuCrBL-M"
  alt="autoplay policy in google chrome video"
  imgSrc="./images/blog/autoplay-policy-in-google-chrome/autoplay-policy-in-google-chrome-video.jpg"
/>
